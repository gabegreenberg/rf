...
program.command('serve-build').description('Serve built site.').option('-h, --host <url>', 'Set host. Defaults to ' + defaultHost, defaultHost).option('-p, --port <port>', 'Set port. Defaults to 8000', '8000').action(function (command) {
